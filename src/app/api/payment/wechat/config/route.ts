  ...
  try {
    ...
    return NextResponse.json({
      ...
      data: {
        ...
        diagnostics: {
          ...
          publicKeyLength: runtimeConfig.publicKey?.length || 0,
          publicKeyIdLength: runtimeConfig.publicKeyId?.length || 0,
    ...
    return NextResponse.json({
      ...
      data: {
        ...
        certMissing: [],
        callbackVerificationConfigured: false,
        callbackVerificationMissing: [],
        callbackVerificationMode: 'unknown',
        appId: '',
        mchId: '',
        notifyUrl: '',
        certPath: '',
